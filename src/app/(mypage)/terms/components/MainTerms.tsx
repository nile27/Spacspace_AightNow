    ...
    <main className="w-full h-auto rounded-2xl p-[32px] min-h-[720px] bg-white ">
      <div className="w-full h-auto flex justify-between items-center mb-[24px] ">
        ...
        <button
          ...
          className="text-secondBlue-600 border-b-[1px] border-secondBlue-600"
        >
          펼쳐서 보기
        </button>
      </div>
      ...
      >
        ...
        <h2 className="mb-5">
          본 약관은 (주)스팩스페이스(이하 "회사"라 함)와 이용자 간의 서비스 이용에 관한 규정을
          명시합니다. 서비스를 이용함으로써 이 약관에 동의한 것으로 간주됩니다. 본 약관은 회사의
          서비스 제공과 관련하여 이용자와 회사 간의 권리, 의무 및 책임사항을 규정하고 있습니다.
        </h2>

        <h2 className="mb-5">제1조 목적</h2>
        <p className="mb-5">
          본 약관은 (주)스팩스페이스가 제공하는 AI 애널리스트 플랫폼 스팩애널리스트 서비스(이하
          "서비스"라 함)를 이용함에 있어 이용자와 회사 간의 권리, 의무 및 책임사항을 규정하는 것을
          목적으로 합니다.
        </p>

        <h2 className="mb-5">제2조 용어의 정의</h2>
        <p>
          "서비스"라 함은 (주)스팩스페이스가 제공하는 AI 애널리스트 플랫폼 스팩애널리스트 서비스를
          말합니다.
        </p>
        <p>"이용자"라 함은 본 약관에 동의하고 회사가 제공하는 서비스를 이용하는 자를 말합니다.</p>
        <p>"회원"이라 함은 서비스에 가입하여 회사가 제공하는 서비스를 이용하는 자를 말합니다.</p>
        <p className="mb-5">
        ...
        <p>
          이용자 여러분께서는 본 약관을 주의 깊게 읽고 서비스를 이용하기 바랍니다. 서비스 이용 시 본
          약관에 동의한 것으로 간주됩니다. 앞으로도 더 나은 서비스를 제공하기 위해 최선을
          다하겠습니다.
        </p>
      </div>
      ...
      <div className="w-full h-auto flex justify-between items-center mb-[24px] ">
        <div className="w-auto h-auto  ">
          <h2 className=" text-body2  text-mainNavy-900 font-bold mb-3">개인정보 처리방침</h2>
        </div>
        <button
          type="button"
      ...
      >
        ...
        <p className="mb-5">
          (주)스팩스페이스는 이용자의 개인정보를 중요하게 생각하며, 정보통신망 이용촉진 및 정보보호
          등에 관한 법률을 준수하고 있습니다. 본 개인정보 처리방침은 회사가 이용자의 개인정보를
          어떻게 수집, 이용, 보호하고 있는지에 대한 내용을 설명합니다.
        </p>
        ...
        <p>
          ...
          파기합니다. 단, 관련 법령에 의해 보존하여야 하는 경우 해당 법령에 따라 보관할 수 있습니다.
        </p>
        ...
        <p>개인정보의 파기</p>
        <p>
          개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 파기의 방법,
          기한은 관련 법령에 따라 진행됩니다.
        </p>
