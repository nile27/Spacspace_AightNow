...
import { fetchTranslate, getNewsArticle, getStockNewsList } from "../../../lib/newsAction";
        ...
        <div className="w-[1200px] flex justify-between mt-[121px]">
          <div className="w-[792px] flex flex-col bg-white p-8 font-pretendard rounded-2xl">
            ...
            <div className="flex flex-col">
              <div className="p-4 rounded-lg mb-4 break-words">
              ...
              {transLoading ? (
                ...
                <div
                  dangerouslySetInnerHTML={{ __html: article.translations[userLanguage] }}
