...
// // ai report
// export async function agentChatTest(id: string) {
...
//     baseUrl: "http://43.203.238.76:8000/generate",
//     model: "llama3",
//     headers: {
//       Authorization: `Bearer ${accessToken}`,
//     },
//     body: {
//       user_message: `최근 ${id} 주식에 대해 분석해줘`,
//       temperature: 0.5,
//       top_p: 0.5,
//     },
//   });
...
// // ai 점수 평가
// export async function agentEvaluationTest(id: string) {
//   const search = new TavilySearchResults({
//     maxResults: 2,
//   });
